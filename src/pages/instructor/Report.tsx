...
export function InstructorReportPage() {
  ...
  const [myReports, setMyReports] = useState([
    { id: 'r1', type: 'Student Flag', against: '@spam_user99', status: 'actioned', date: '2d ago', feedback: 'We have permanently banned this user for repeated spam violations in the Q&A.' }
  ])
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setToast('Report submitted successfully. Our admin team will investigate.')
      setType('')
      setOffender('')
      setDescription('')
      setFileName('')
  ...
  return (
    <DashLayout sidebarItems={NAV} title="Report an Issue" subtitle="Flag students, payment problems, or platform bugs">
      <Card className="p-6 max-w-xl">
        <form onSubmit={handleSubmit}>
          <div className="mb-5">
            <label className="block text-[12px] font-[600] text-[var(--text-secondary)] mb-2">Report Type *</label>
            <select
              required
              value={type}
            ...
            >
              ...
              <option value="platform_issue">Platform/Technical Issue</option>
              <option value="student_flag">Flag a Student (Spam/Harassment)</option>
          ...
          <div className="mb-5">
            <label className="block text-[12px] font-[600] text-[var(--text-secondary)] mb-2">Details & Description *</label>
            <textarea
              required
              rows={6}
              value={description}
