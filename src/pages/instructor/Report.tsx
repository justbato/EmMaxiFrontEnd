    ...
    <DashLayout sidebarItems={NAV} title="Report an Issue" subtitle="Flag students, payment problems, or platform bugs">
      <Card className="p-6 max-w-xl">
        <form onSubmit={handleSubmit}>
          <div className="mb-5">
            <label className="block text-[12px] font-[600] text-[#333] mb-2">Report Type *</label>
            <select
              required
              value={type}
          ...
          <div className="mb-5">
            <label className="block text-[12px] font-[600] text-[#333] mb-2">Details & Description *</label>
            <textarea
              required
              rows={6}
              value={description}
